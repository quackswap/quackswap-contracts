...
describe("BridgeMigrationRouter", async function() {
    ...
    before(async () => {
        ...
        const factory = await ethers.getContractAt("QuackSwapFactory", fixture.Factory)
        const router = await ethers.getContractAt("QuackSwapRouter", fixture.Router)
    ...
    beforeEach(async () => {
        ...
        factory = await ethers.getContractFactory("QuackSwapBridgeMigrationRouter")
